...
./waf copter
# mkdir firmware/TH-2
cp build/TH-2/bin/arducopter.apj firmware/$current_datetime\_TH-2_arducopter.apj
echo "~~~~~~~~~~~~~~~ next ~~~~~~~~~~~~~~~"
./waf configure --board TH-2-sim
./waf copter
# mkdir firmware/TH-2
cp build/TH-2-sim/bin/arducopter.apj firmware/$current_datetime\_TH-2_sim_arducopter.apj
echo "~~~~~~~~~~~~~~~ next ~~~~~~~~~~~~~~~"
