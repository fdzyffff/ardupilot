...
AC_CustomControl_ADRC::AC_CustomControl_ADRC(AC_CustomControl& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl_Multi*& att_control, AP_MotorsMulticopter*& motors, float dt) :
    ...
    _adrc_atti_rate_roll(AC_ATC_MULTI_RATE_RP_B0, AC_ATC_MULTI_RATE_RP_KP, AC_ATC_MULTI_RATE_RP_KD, AC_ATC_MULTI_RATE_RP_KA, AC_ATC_MULTI_RATE_RP_KB, AC_ATC_MULTI_RATE_RP_KC, AC_ATC_MULTI_RATE_RP_OMEGA0, AC_ATC_MULTI_RATE_RP_IMAX, AC_ATC_MULTI_RATE_RP_FILT_HZ, 0.0f, AC_ATC_MULTI_RATE_RP_FILT_HZ),
    _adrc_atti_rate_pitch(AC_ATC_MULTI_RATE_RP_B0, AC_ATC_MULTI_RATE_RP_KP, AC_ATC_MULTI_RATE_RP_KD, AC_ATC_MULTI_RATE_RP_KA, AC_ATC_MULTI_RATE_RP_KB, AC_ATC_MULTI_RATE_RP_KC, AC_ATC_MULTI_RATE_RP_OMEGA0, AC_ATC_MULTI_RATE_RP_IMAX, AC_ATC_MULTI_RATE_RP_FILT_HZ, 0.0f, AC_ATC_MULTI_RATE_RP_FILT_HZ),
    _adrc_atti_rate_yaw(AC_ATC_MULTI_RATE_YAW_B0, AC_ATC_MULTI_RATE_YAW_KP, AC_ATC_MULTI_RATE_YAW_KD, AC_ATC_MULTI_RATE_YAW_KA, AC_ATC_MULTI_RATE_YAW_KB, AC_ATC_MULTI_RATE_YAW_KC, AC_ATC_MULTI_RATE_YAW_OMEGA0, AC_ATC_MULTI_RATE_YAW_IMAX, AC_ATC_MULTI_RATE_RP_FILT_HZ, AC_ATC_MULTI_RATE_YAW_FILT_HZ, 0.0f)
{
