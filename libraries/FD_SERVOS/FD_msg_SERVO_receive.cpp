...
FD_msg_SERVO_receive::FD_msg_SERVO_receive(void)
{
    _enable = false;
...
void FD_msg_SERVO_receive::parse(uint8_t temp)
{
...
void FD_msg_SERVO_receive::process_message(void)
{
    int16_t i = 0;
...
void FD_msg_SERVO_receive::swap_message(void)
{
...
void FD_msg_SERVO_receive::sum_check(void)
{
    ;
}
