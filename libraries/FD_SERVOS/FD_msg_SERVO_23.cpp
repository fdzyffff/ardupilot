...
FD_msg_SERVO_23::FD_msg_SERVO_23(void)
{
    _enable = false;
...
void FD_msg_SERVO_23::parse(uint8_t temp)
{
    ;
}

void FD_msg_SERVO_23::process_message(void)
{
    ;
}

void FD_msg_SERVO_23::swap_message(void)
{
...
void FD_msg_SERVO_23::sum_check(void)
{
