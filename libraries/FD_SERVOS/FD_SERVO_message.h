...
class FD_SERVO_message {
public:

    FD_SERVO_message() {_enable = false;}
    
    /* Do not allow copies */
    FD_SERVO_message(const FD_SERVO_message &other) = delete;
    FD_SERVO_message &operator=(const FD_SERVO_message&) = delete;
