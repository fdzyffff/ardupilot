...
#define FD_MSG_SERVO_15_LEN 18
class FD_msg_SERVO_15 : public FD_SERVO_message{
public:
    ...
    union PACKED Content_1 {
        MSG_Command_1 msg;
        uint8_t data[FD_MSG_SERVO_15_LEN];
    };
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    struct PACKED FD1UART_MSG_1 {
        ...
        bool updated;
        bool need_send;
        uint16_t length = FD_MSG_SERVO_15_LEN;
        Content_1 content;
    };
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /* Do not allow copies */
    FD_msg_SERVO_15(const FD_msg_SERVO_15 &other) = delete;
    FD_msg_SERVO_15 &operator=(const FD_msg_SERVO_15&) = delete;

    static const uint8_t PREAMBLE1 = 0x12;
    static const uint8_t PREAMBLE2 = 0x4C;
    static const uint8_t DATA_ID = 15;
