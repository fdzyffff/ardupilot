...
FD_msg_SERVO_15::FD_msg_SERVO_15(void)
{
    _enable = false;
...
void FD_msg_SERVO_15::parse(uint8_t temp)
{
    ;
}

void FD_msg_SERVO_15::process_message(void)
{
    ;
}

void FD_msg_SERVO_15::swap_message(void)
{
...
void FD_msg_SERVO_15::sum_check(void)
{
