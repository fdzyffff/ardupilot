...
FD_msg_SERVO_17::FD_msg_SERVO_17(void)
{
    _enable = false;
...
void FD_msg_SERVO_17::parse(uint8_t temp)
{
    ;
}

void FD_msg_SERVO_17::process_message(void)
{
    ;
}

void FD_msg_SERVO_17::swap_message(void)
{
...
void FD_msg_SERVO_17::sum_check(void)
{
