...
public:
    ...
    // Constructor for PID
    AC_ADRC_3rd(float initial_b0, float intial_l1, float intial_l2, float intial_l3, float intial_l4, float intial_ka, float intial_kb, float intial_kc, float intial_kd, float initial_omega_o, 
               float initial_imax, float initial_filt_T_hz, float initial_filt_E_hz, float initial_filt_D_hz,
               float initial_srmax=0, float initial_srtau=1.0);

    CLASS_NO_COPY(AC_ADRC_3rd);
    ...
    void operator()(float b0_val, float l1_val, float l2_val, float l3_val, float l4_val, float ka_val, float kb_val, float kc_val, float kd_val, float omega_o_val, 
                   float imax_val, float filt_T_hz_val, float filt_E_hz_val, float filt_D_hz_val, float slew_rate_max_val);
