...
FD_DYT_NEW_msg_APM2DYTCONTROL::FD_DYT_NEW_msg_APM2DYTCONTROL(void)
{
    _enable = false;
...
void FD_DYT_NEW_msg_APM2DYTCONTROL::parse(uint8_t temp)
{
...
void FD_DYT_NEW_msg_APM2DYTCONTROL::process_message(void)
{
    int16_t i = 0;
...
void FD_DYT_NEW_msg_APM2DYTCONTROL::swap_message(void)
{
...
void FD_DYT_NEW_msg_APM2DYTCONTROL::sum_check(void)
{
    int16_t i = 0;
