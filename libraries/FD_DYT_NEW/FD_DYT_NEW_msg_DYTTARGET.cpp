...
FD_DYT_NEW_msg_DYTTARGET::FD_DYT_NEW_msg_DYTTARGET(void)
{
    _enable = false;
...
void FD_DYT_NEW_msg_DYTTARGET::parse(uint8_t temp)
{
...
void FD_DYT_NEW_msg_DYTTARGET::process_message(void)
{
    int16_t i = 0;
...
void FD_DYT_NEW_msg_DYTTARGET::swap_message(void)
{
...
void FD_DYT_NEW_msg_DYTTARGET::sum_check(void)
{
    int16_t i = 0;
