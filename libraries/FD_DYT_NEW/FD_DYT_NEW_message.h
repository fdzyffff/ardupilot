...
class FD_DYT_NEW_message {
public:

    FD_DYT_NEW_message() {_enable = false;}
    
    /* Do not allow copies */
    FD_DYT_NEW_message(const FD_DYT_NEW_message &other) = delete;
    FD_DYT_NEW_message &operator=(const FD_DYT_NEW_message&) = delete;
