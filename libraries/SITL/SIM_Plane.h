...
protected:
    const float hover_throttle = 0.8f;
    ...
    struct {
        ...
        float b = 13.03;//20
        float c = 0.34;//1
        float c_lift_0 = 0.1053;
        float c_lift_deltae = 0.4698;
        float c_lift_a = 4.76;//3.9
        float c_lift_q = 0;
        float mcoeff = 50;
        float oswald = 0.8;
        ...
        float c_drag_p = 0.038;//0.2
        float c_y_0 = 0;
        float c_y_b = -0.8366;//-0.98
        float c_y_p = 0;
        float c_y_r = 0;
        float c_y_deltaa = 0;
        ...
        float c_l_0 = 0;
        float c_l_p = -0.265;//-1
        float c_l_b = -0.4;//-0.12
        float c_l_r = 0.14;
        float c_l_deltaa = 0.057;//0.25
        float c_l_deltar = -0.037;
        float c_m_0 = 0.1015;//0.045
        float c_m_a = -0.7;
        float c_m_q = -20;
        float c_m_deltae = 1.169;
        float c_n_0 = 0;
        float c_n_b = 0.23;
        float c_n_p = 0.022;
        float c_n_r = -0.058;//-1
        float c_n_deltaa = 0.00;
        float c_n_deltar = 0.023;//0.2
