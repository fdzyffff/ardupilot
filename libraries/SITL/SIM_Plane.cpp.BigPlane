    ...
    Aircraft(frame_str)
{
    ...
    /*
       ...
       这相当于推重比是1，因此做更改。
    */
    thrust_scale = (45 * GRAVITY_MSS) / hover_throttle;//地面推力/悬停油门，thrust现在单独计算
...
Vector3f Plane::getTorque(float inputAileron, float inputElevator, float inputRudder, float inputThrust, const Vector3f &force) const
{
	...
	// r x F, where r is the distance from CoG to CoL 也就是稳定裕度，重心和焦点，但cm里已经是对重心取力矩，因此r=0
