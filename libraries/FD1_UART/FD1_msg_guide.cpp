...
FD1_msg_guide::FD1_msg_guide(void)
{
    _enable = false;
...
void FD1_msg_guide::parse(uint8_t temp)
{
...
void FD1_msg_guide::process_message(void)
{
    int16_t i = 0;
...
bool FD1_msg_guide::sum_check(void)
{
    int16_t i = 0;
...
void FD1_msg_guide::swap_message(void)
{
