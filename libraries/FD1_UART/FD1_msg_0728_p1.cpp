...
FD1_msg_0728_p1::FD1_msg_0728_p1(void)
{
    _enable = false;
...
void FD1_msg_0728_p1::parse(uint8_t temp)
{
    switch (_msg.msg_state)
    {
        ...
        case FD1UART_msg_parser::FD1UART_PREAMBLE2:
            if (temp == PREAMBLE2)
            {
                ...
                _msg.read++;
                _msg.sum = 0;
                _msg.length = FD1_MSG_0728_P1_LEN;
...
void FD1_msg_0728_p1::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_0728_p1::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD1_msg_0728_p1::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD1_msg_0728_p1::PREAMBLE2;
...
void FD1_msg_0728_p1::swap_message(void)
{
    ;
}
