...
FD1_msg_info::FD1_msg_info(void)
{
    _enable = false;
...
void FD1_msg_info::parse(uint8_t temp)
{
...
void FD1_msg_info::process_message(void)
{
    int16_t i = 0;
...
bool FD1_msg_info::sum_check(void)
{
    int16_t i = 0;
...
void FD1_msg_info::swap_message(void)
{
