...
public:
    ...
    struct PACKED MSG_Input_56H {//遥控帧字节  信号名          参数范围                精度          分辨率           变换关系
        ...
        float    wp_pos_x;      // 33~36      X   　          -10000000m-10000000m   0.01m         1/100           Y=X/100
        float    wp_pos_y;      // 37~40      Y   　          -10000000m-10000000m   0.01m         1/100           Y=X/100
        float    wp_pos_z;      // 41~44      Z   　          -10000000m-10000000m   0.01m         1/100           Y=X/100
