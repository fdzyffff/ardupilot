#include "FD1_msg_apm2gimbal.h"
// #include <GCS_MAVLink/GCS.h>

FD1_msg_apm2gimbal::FD1_msg_apm2gimbal(void)
{
    _enable = false;
...
void FD1_msg_apm2gimbal::parse(uint8_t temp)
{
    switch (_msg.msg_state)
    {
        ...
        case FD1UART_msg_parser::FD1UART_PREAMBLE2:
            if (temp == PREAMBLE2)
            {
                ...
                _msg.read++;
                _msg.length = FD1_MSG_APM2GIMBAL_LEN;
...
void FD1_msg_apm2gimbal::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_apm2gimbal::swap_message(void)
{
