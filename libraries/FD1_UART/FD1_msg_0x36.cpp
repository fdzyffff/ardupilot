...
FD1_msg_0x36::FD1_msg_0x36(void)
{
    _enable = false;
...
void FD1_msg_0x36::parse(uint8_t temp)
{
...
void FD1_msg_0x36::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_0x36::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD1_msg_0x36::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD1_msg_0x36::PREAMBLE2;
...
void FD1_msg_0x36::swap_message(void)
{
    ;
}
