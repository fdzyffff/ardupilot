...
public:
    ...
    union PACKED Content_1 {
        MSG_Collection msg;
        uint8_t data[FD1_MSG_0919_P2_LEN];
    };
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    struct PACKED FD1UART_MSG_1 {
        ...
        bool updated;
        bool need_send;
        uint16_t length = FD1_MSG_0919_P2_LEN;
        Content_1 content;
    };
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /* Do not allow copies */
    FD1_msg_0919_p2(const FD1_msg_0919_p2 &other) = delete;
    FD1_msg_0919_p2 &operator=(const FD1_msg_0919_p2&) = delete;

    static const uint8_t PREAMBLE1 = 0xC1;
    static const uint8_t PREAMBLE2 = 0xE3;
