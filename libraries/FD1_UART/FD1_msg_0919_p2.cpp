#include "FD1_msg_0919_p2.h"
// #include <GCS_MAVLink/GCS.h>

FD1_msg_0919_p2::FD1_msg_0919_p2(void)
{
    _enable = false;
...
void FD1_msg_0919_p2::parse(uint8_t temp)
{
    switch (_msg.msg_state)
    {
        ...
        case FD1UART_msg_parser::FD1UART_PREAMBLE2:
            if (temp == PREAMBLE2)
            {
                ...
                _msg.read++;
                // _msg.sum ^= temp;
                _msg.length = FD1_MSG_0919_P2_LEN;
...
void FD1_msg_0919_p2::process_message(void)
{
    uint16_t i = 0;
...
void FD1_msg_0919_p2::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD1_msg_0919_p2::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD1_msg_0919_p2::PREAMBLE2;
...
void FD1_msg_0919_p2::swap_message(void)
{
    ;
}
