...
FD1_msg_0x11::FD1_msg_0x11(void)
{
    _enable = false;
...
void FD1_msg_0x11::parse(uint8_t temp)
{
    ;
}

void FD1_msg_0x11::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_0x11::swap_message(void)
{
    ;
}
