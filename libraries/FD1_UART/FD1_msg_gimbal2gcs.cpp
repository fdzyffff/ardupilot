#include "FD1_msg_gimbal2gcs.h"
// #include <GCS_MAVLink/GCS.h>

FD1_msg_gimbal2gcs::FD1_msg_gimbal2gcs(void)
{
    _enable = false;
    ...
    switch (_msg.msg_state)
    {
        ...
        case FD1UART_msg_parser::FD1UART_PREAMBLE2:
            if (temp == PREAMBLE2)
            {
                ...
                _msg.read++;
                _msg.length = FD1_MSG_GIMBAL2GCS_LEN;
...
void FD1_msg_gimbal2gcs::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_gimbal2gcs::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD1_msg_gimbal2gcs::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD1_msg_gimbal2gcs::PREAMBLE2;
    _msg_1.content.msg.end = FD1_msg_gimbal2gcs::POSTAMBLE1;
...
void FD1_msg_gimbal2gcs::swap_message(void)
{
