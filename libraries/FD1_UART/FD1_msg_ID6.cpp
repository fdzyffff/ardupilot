...
void FD1_msg_ID6::parse(uint8_t temp)
{
...
void FD1_msg_ID6::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_ID6::swap_message(void)
{
...
void FD1_msg_ID6::cal_sumcheck(void)
{
