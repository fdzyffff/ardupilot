...
FD1_msg_0x37::FD1_msg_0x37(void)
{
    _enable = false;
...
void FD1_msg_0x37::parse(uint8_t temp)
{
...
void FD1_msg_0x37::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_0x37::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD1_msg_0x37::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD1_msg_0x37::PREAMBLE2;
...
void FD1_msg_0x37::swap_message(void)
{
    ;
}
