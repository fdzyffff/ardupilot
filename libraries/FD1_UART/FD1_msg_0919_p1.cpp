#include "FD1_msg_0919_p1.h"
#include <GCS_MAVLink/GCS.h>

FD1_msg_0919_p1::FD1_msg_0919_p1(void)
{
    _enable = false;
...
void FD1_msg_0919_p1::parse(uint8_t temp)
{
    switch (_msg.msg_state)
    {
        ...
        case FD1UART_msg_parser::FD1UART_PREAMBLE2:
            if (temp == PREAMBLE2)
            {
                ...
                _msg.read++;
                // _msg.sum ^= temp;
                _msg.length = FD1_MSG_0919_P1_LEN;
        ...
        case FD1UART_msg_parser::FD1UART_DATA:
            ...
            if (_msg.read == 2) {
                _msg.length = temp+4;
                gcs().send_text(MAV_SEVERITY_INFO, "length: %d",_msg.length);
            }
...
void FD1_msg_0919_p1::process_message(void)
{
    uint16_t i = 0;
...
void FD1_msg_0919_p1::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD1_msg_0919_p1::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD1_msg_0919_p1::PREAMBLE2;
...
void FD1_msg_0919_p1::swap_message(void)
{
    ;
}
