...
FD1_msg_mission::FD1_msg_mission(void)
{
    _enable = false;
...
void FD1_msg_mission::parse(uint8_t temp)
{
...
void FD1_msg_mission::process_message(void)
{
    int16_t i = 0;
...
bool FD1_msg_mission::sum_check(void)
{
    int16_t i = 0;
...
void FD1_msg_mission::swap_message(void)
{
