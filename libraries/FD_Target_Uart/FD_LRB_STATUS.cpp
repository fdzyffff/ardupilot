...
FD_LRB_STATUS::FD_LRB_STATUS(void)
{
    _enable = false;
...
void FD_LRB_STATUS::parse(uint8_t temp)
{
...
void FD_LRB_STATUS::process_message(void)
{
    int16_t i = 0;
...
void FD_LRB_STATUS::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD_LRB_STATUS::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD_LRB_STATUS::PREAMBLE2;
    _msg_1.length = FD_LRB_STATUS_LEN;
...
void FD_LRB_STATUS::swap_message(void)
{
    ;
}
