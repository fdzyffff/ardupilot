...
class FD_K230_message {
public:

    FD_K230_message() {_enable = false;}
    
    /* Do not allow copies */
    FD_K230_message(const FD_K230_message &other) = delete;
    FD_K230_message &operator=(const FD_K230_message&) = delete;
