...
void FD_LRB_CMD::parse(uint8_t temp)
{
...
void FD_LRB_CMD::process_message(void)
{
    int16_t i = 0;
...
void FD_LRB_CMD::make_sum()
{
    _msg_1.content.msg.header.head_1 = FD_LRB_CMD::PREAMBLE1;
    _msg_1.content.msg.header.head_2 = FD_LRB_CMD::PREAMBLE2;
    _msg_1.length = FD_LRB_CMD_LEN;
...
void FD_LRB_CMD::swap_message(void)
{
    ;
}
