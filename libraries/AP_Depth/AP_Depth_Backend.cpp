...
// constructor
AP_Depth_Backend::AP_Depth_Backend(AP_Depth &depth) : 
    _frontend(depth) 
{
}

void AP_Depth_Backend::update_healthy_flag(uint8_t instance)
{
 ...
 */
void AP_Depth_Backend::_copy_to_frontend(uint8_t instance, float pressure, float temperature)
{
    if (instance >= _frontend._num_sensors) {
        return;
    }
 ...
 * rejected. 
*/
bool AP_Depth_Backend::pressure_ok(float press)
{
