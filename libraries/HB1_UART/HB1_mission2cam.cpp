...
HB1_mission2cam::HB1_mission2cam(void)
{
    _enable = false;
...
void HB1_mission2cam::parse(uint8_t temp)
{
...
void HB1_mission2cam::process_message(void)
{
    int16_t i = 0;
    switch (_msg.header.index) {
        case INDEX1:
...
void HB1_mission2cam::swap_message(void)
{
