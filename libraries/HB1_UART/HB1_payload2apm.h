...
#define HB1_MSG_PAYLOADAPM_LEN 6
class HB1_payload2apm : public HB1_message{
public:
    ...
    union PACKED Content_1 {
        MSG_Command_1 msg;
        uint8_t data[HB1_MSG_PAYLOADAPM_LEN];
    };
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    struct PACKED HB1_UART_MSG_1 {
        ...
        bool updated;
        bool need_send;
        const uint16_t length = HB1_MSG_PAYLOADAPM_LEN;
        Content_1 content;
    };
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    /* Do not allow copies */
    HB1_payload2apm(const HB1_payload2apm &other) = delete;
    HB1_payload2apm &operator=(const HB1_payload2apm&) = delete;
