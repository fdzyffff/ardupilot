...
// Convenience macros //////////////////////////////////////////////////////////
//
const AP_Param::GroupInfo FD_Target_FP847::var_info[] = {

    AP_GROUPINFO("TOUT",   0, FD_Target_FP847, target_timeout,        2000),
    AP_GROUPINFO("PIX_W",  1, FD_Target_FP847, cam_width,             360),
    AP_GROUPINFO("PIX_H",  2, FD_Target_FP847, cam_height,            360),
    AP_GROUPINFO("ANG_X",  3, FD_Target_FP847, cam_angle_x,           60.0f),
    AP_GROUPINFO("ANG_Y",  4, FD_Target_FP847, cam_angle_y,           60.0f),

    AP_GROUPEND
};

FD_Target_FP847::FD_Target_FP847()
{
    AP_Param::setup_object_defaults(this, var_info);
    return;
}

bool FD_Target_FP847::init() {
    _last_ms = 0;
    _valid = false;
    set_type(0);
    return true;
...
float FD_Target_FP847::cal_frame_angle(float pixel, float angle, float x_in)
{
    // pixel, eg: 1080
    // angle, eg: 54°
    // x_in, eg: 540
...
void FD_Target_FP847::handle_info_test(float p1, float p2) {
    handle_info(p1, p2);
...
void FD_Target_FP847::handle_msg(const mavlink_message_t &msg)
{
