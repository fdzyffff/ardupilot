...
FD2_msg_ue4_ahrs::FD2_msg_ue4_ahrs(void)
{
    _enable = false;
...
void FD2_msg_ue4_ahrs::parse(uint8_t temp)
{
...
void FD2_msg_ue4_ahrs::process_message(void)
{
    int16_t i = 0;
...
void FD2_msg_ue4_ahrs::swap_message(void)
{
