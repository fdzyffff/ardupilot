...
class AS_PitchController
{
public:
    AS_PitchController(const AP_Vehicle::FixedWing &parms);

    /* Do not allow copies */
    AS_PitchController(const AS_PitchController &other) = delete;
    AS_PitchController &operator=(const AS_PitchController&) = delete;
