...
class AS_YawController
{
public:
    AS_YawController(const AP_Vehicle::FixedWing &parms);

    /* Do not allow copies */
    AS_YawController(const AS_YawController &other) = delete;
    AS_YawController &operator=(const AS_YawController&) = delete;
