...
class AS_RollController
{
public:
    AS_RollController(const AP_Vehicle::FixedWing &parms);

    /* Do not allow copies */
    AS_RollController(const AS_RollController &other) = delete;
    AS_RollController &operator=(const AS_RollController&) = delete;
