...
const AP_Param::GroupInfo AS_YawController::var_info[] = {
    ...
    // @Increment: 0.25
    // @User: Advanced
    AP_GROUPINFO("2SRV_SLIP",    0, AS_YawController, _K_A,    0),
    ...
    // @Increment: 0.25
    // @User: Advanced
    AP_GROUPINFO("2SRV_INT",    1, AS_YawController, _K_I,    0),
    ...
    // @Increment: 0.25
    // @User: Advanced
    AP_GROUPINFO("2SRV_DAMP",   2, AS_YawController, _K_D,    0),
    ...
    // @Increment: 0.05
    // @User: Advanced
    AP_GROUPINFO("2SRV_RLL",   3, AS_YawController, _K_FF,   1),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("2SRV_IMAX",  5, AS_YawController, _imax,        1500),
    ...
    // @User: Advanced
    AP_GROUPINFO_FLAGS("_RATE_ENABLE",  6, AS_YawController, _rate_enable, 0, AP_PARAM_FLAG_ENABLE),
    ...
    AP_SUBGROUPINFO(rate_pid, "_RATE_", 9, AS_YawController, AC_PID),

    AP_GROUPEND
};

AS_YawController::AS_YawController(const AP_Vehicle::FixedWing &parms)
    : aparm(parms)
{
...
int32_t AS_YawController::get_servo_out(float scaler, bool disable_integrator)
{
...
float AS_YawController::get_rate_out(float desired_rate, float scaler, bool disable_integrator)
{
    const AP_AHRS &_ahrs = AP::ahrs();
...
void AS_YawController::reset_rate_PID()
{
    rate_pid.reset_I();
...
/*
  start an autotune
 */
void AS_YawController::autotune_start(void)
{
 ...
 */
void AS_YawController::autotune_restore(void)
{
    if (autotune != nullptr) {
        autotune->stop();
    }
