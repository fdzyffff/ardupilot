...
/// @class      AP_MotorsSkateboard
class AP_MotorsSkateboard : public AP_MotorsMulticopter {
public:

    /// Constructor
    AP_MotorsSkateboard(uint16_t loop_rate, uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT) :
...
protected:
    ...
    const char* _get_frame_string() const override { return "SkateBoard"; }
