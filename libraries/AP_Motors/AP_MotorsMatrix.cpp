        ...
        case MOTOR_FRAME_QUAD:
            switch (frame_type) {
                ...
                case MOTOR_FRAME_TYPE_PLUSREV:
                    ...
                    break;
                case MOTOR_FRAME_TYPE_Y4:  // 1: left CW, 2: right CCW, 3 Up CW, 4: Down CCW
                    // plus with reversed motor directions
                    add_motor_raw(AP_MOTORS_MOT_1, 1.0f, 0.2f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 1);
                    add_motor_raw(AP_MOTORS_MOT_2, -1.0f, 0.2f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 2);
                    add_motor_raw(AP_MOTORS_MOT_3, 0.0f, -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 3);
                    add_motor_raw(AP_MOTORS_MOT_4, 0.0f, -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 4);
                    break;
                default:
