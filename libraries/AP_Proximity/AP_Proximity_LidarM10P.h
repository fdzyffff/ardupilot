...
#define PROXIMITY_M10P_TIMEOUT_MS            300                               // requests timeout after 0.3 seconds
...
public:
    ...
    AP_Proximity_LidarM10P(AP_Proximity &_frontend,
...
private:
    ...
    FD1_msg_M10P _msg_M10P;   //NAV系列惯导-惯导数据
    ...
    public:
        ...
        AP_Proximity_LidarM10P *_frontend;
        float _angle_min;
        float _angle_max;
