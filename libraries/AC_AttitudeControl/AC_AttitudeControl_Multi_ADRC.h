...
/// @file    AC_AttitudeControl_Multi_ADRC.h
...
class AC_AttitudeControl_Multi_ADRC : public AC_AttitudeControl {
public:
	AC_AttitudeControl_Multi_ADRC(AP_AHRS_View &ahrs, const AP_Vehicle::MultiCopter &aparm, AP_MotorsMulticopter& motors);

	// empty destructor to suppress compiler warning
	virtual ~AC_AttitudeControl_Multi_ADRC() {}
