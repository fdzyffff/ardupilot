#include "AC_AttitudeControl_Multi_ADRC.h"
#include <AP_HAL/AP_HAL.h>
#include <AP_Math/AP_Math.h>

// table of user settable parameters
const AP_Param::GroupInfo AC_AttitudeControl_Multi_ADRC::var_info[] = {
    ...
    AP_SUBGROUPINFO(_pid_rate_roll, "RAT_RLL_", 1, AC_AttitudeControl_Multi_ADRC, AC_PID),
    ...
    AP_SUBGROUPINFO(_pid_rate_pitch, "RAT_PIT_", 2, AC_AttitudeControl_Multi_ADRC, AC_PID),
    ...
    AP_SUBGROUPINFO(_pid_rate_yaw, "RAT_YAW_", 3, AC_AttitudeControl_Multi_ADRC, AC_PID),
    ...
    // @Range: 0.1 0.25
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MIN", 4, AC_AttitudeControl_Multi_ADRC, _thr_mix_min, AC_ATTITUDE_CONTROL_MIN_DEFAULT),
    ...
    // @Range: 0.5 0.9
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MAX", 5, AC_AttitudeControl_Multi_ADRC, _thr_mix_max, AC_ATTITUDE_CONTROL_MAX_DEFAULT),
    ...
    // @Range: 0.1 0.9
    // @User: Advanced
    AP_GROUPINFO("THR_MIX_MAN", 6, AC_AttitudeControl_Multi_ADRC, _thr_mix_man, AC_ATTITUDE_CONTROL_MAN_DEFAULT),

    AP_GROUPEND
};

AC_AttitudeControl_Multi_ADRC::AC_AttitudeControl_Multi_ADRC(AP_AHRS_View &ahrs, const AP_Vehicle::MultiCopter &aparm, AP_MotorsMulticopter& motors) :
...
void AC_AttitudeControl_Multi_ADRC::update_althold_lean_angle_max(float throttle_in)
{
...
void AC_AttitudeControl_Multi_ADRC::set_throttle_out(float throttle_in, bool apply_angle_boost, float filter_cutoff)
{
...
void AC_AttitudeControl_Multi_ADRC::set_throttle_mix_max(float ratio)
{
...
float AC_AttitudeControl_Multi_ADRC::get_throttle_boosted(float throttle_in)
{
...
// returns a throttle including compensation for roll/pitch angle
// throttle value should be 0 ~ 1
float AC_AttitudeControl_Multi_ADRC::get_throttle_avg_max(float throttle_in)
{
...
void AC_AttitudeControl_Multi_ADRC::update_throttle_rpy_mix()
{
...
void AC_AttitudeControl_Multi_ADRC::rate_controller_run()
{
...
void AC_AttitudeControl_Multi_ADRC::parameter_sanity_check()
{
