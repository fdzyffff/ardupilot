...
// Convenience macros //////////////////////////////////////////////////////////
//
const AP_Param::GroupInfo FD_Gimbal_HaoFu::var_info[] = {

    AP_GROUPINFO("TOUT",   0, FD_Gimbal_HaoFu, target_timeout,        2000),
    AP_GROUPINFO("PIX_W",  1, FD_Gimbal_HaoFu, cam_width,             360),
    AP_GROUPINFO("PIX_H",  2, FD_Gimbal_HaoFu, cam_height,            360),
    AP_GROUPINFO("ANG_X",  3, FD_Gimbal_HaoFu, cam_angle_x,           60.0f),
    AP_GROUPINFO("ANG_Y",  4, FD_Gimbal_HaoFu, cam_angle_y,           60.0f),

    AP_GROUPEND
};

FD_Gimbal_HaoFu::FD_Gimbal_HaoFu()
{
    AP_Param::setup_object_defaults(this, var_info);
    return;
}

bool FD_Gimbal_HaoFu::init() {
    return true;
}

void FD_Gimbal_HaoFu::update() {
...
void FD_Gimbal_HaoFu::handle_msg(const mavlink_message_t &msg)
{
...
float FD_Gimbal_HaoFu::cal_frame_angle(float pixel, float angle, float x_in)
{
    // pixel, eg: 1080
    // angle, eg: 54°
    // x_in, eg: 540
...
void FD_Gimbal_HaoFu::handle_info_test(float p1, float p2) {
