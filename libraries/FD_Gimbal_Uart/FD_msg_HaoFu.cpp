...
FD_msg_HaoFu::FD_msg_HaoFu(void)
{
    _enable = false;
...
void FD_msg_HaoFu::parse(uint8_t temp)
{
...
void FD_msg_HaoFu::process_message(void)
{
    int16_t i = 0;
...
void FD_msg_HaoFu::swap_message(void)
{
...
void FD_msg_HaoFu::sum_check(void)
{
