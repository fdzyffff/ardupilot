...
class FD_DYT_NET_message {
public:

    FD_DYT_NET_message() {_enable = false;}
    
    /* Do not allow copies */
    FD_DYT_NET_message(const FD_DYT_NET_message &other) = delete;
    FD_DYT_NET_message &operator=(const FD_DYT_NET_message&) = delete;
