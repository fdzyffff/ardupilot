...
FD_DYT_NET_msg_APM2DYTTELEM::FD_DYT_NET_msg_APM2DYTTELEM(void)
{
    _enable = false;
...
void FD_DYT_NET_msg_APM2DYTTELEM::parse(uint8_t temp)
{
    ;
}

void FD_DYT_NET_msg_APM2DYTTELEM::process_message(void)
{
    int16_t i = 0;
...
void FD_DYT_NET_msg_APM2DYTTELEM::swap_message(void)
{
...
void FD_DYT_NET_msg_APM2DYTTELEM::sum_check(void)
{
    int16_t i = 0;
