...
FD_DYT_NET_msg_DYTTELEM::FD_DYT_NET_msg_DYTTELEM(void)
{
    _enable = false;
...
void FD_DYT_NET_msg_DYTTELEM::parse(uint8_t temp)
{
...
void FD_DYT_NET_msg_DYTTELEM::process_message(void)
{
    int16_t i = 0;
...
void FD_DYT_NET_msg_DYTTELEM::swap_message(void)
{
...
void FD_DYT_NET_msg_DYTTELEM::sum_check(void)
{
    int16_t i = 0;
