...
FD1_msg_0XA1::FD1_msg_0XA1(void)
{
    _enable = false;
...
void FD1_msg_0XA1::parse(uint8_t temp)
{
...
void FD1_msg_0XA1::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_0XA1::swap_message(void)
{
