...
FD1_msg_0XCC::FD1_msg_0XCC(void)
{
    _enable = false;
...
void FD1_msg_0XCC::parse(uint8_t temp)
{
...
void FD1_msg_0XCC::process_message(void)
{
    int16_t i = 0;
...
void FD1_msg_0XCC::swap_message(void)
{
