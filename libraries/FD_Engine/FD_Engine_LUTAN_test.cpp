...
void FD_Engine_LUTAN::test_uart(uint8_t msg_id, uint8_t option)
{
    switch (msg_id) {
        case 1:
            test_LUTAN_in(option);
            break;
        case 2:
            test_LUTAN_out(option);
            break;
        default:
            break;
    }
...
void FD_Engine_LUTAN::test_LUTAN_in(uint8_t option) {
...
void FD_Engine_LUTAN::test_LUTAN_out(uint8_t option) {
    // static uint8_t n_count = 0;
