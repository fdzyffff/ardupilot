...
class ModeJSFence : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::JSFENCE; }
...
protected:
    ...
    const char *name() const override { return "JSFENCE"; }
    const char *name4() const override { return "JFNC"; }
