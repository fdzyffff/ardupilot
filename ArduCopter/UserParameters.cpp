...
const AP_Param::GroupInfo UserParameters::var_info[] = {
    ...
    AP_GROUPINFO("_A_K_ANGLE",     4, UserParameters, attack_k_angle,          1.0f),
    AP_GROUPINFO("_A_K_ROLL",      5, UserParameters, attack_roll_factor,      1.0f),
    ...
    AP_SUBGROUPINFO(attack_throttle_pid, "_ATKTHR_", 13, UserParameters, AC_PID),
