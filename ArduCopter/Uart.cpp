...
void Uart::read_uart()
{
    ...
    while (get_port()->available()>0) {
        ...
        if (temp == 44) { //","
            ...
            gcs().send_text(MAV_SEVERITY_INFO, "t 2 %x", hex_temp);
        }
    }
}
...
void Uart::send_0919_p3()
{
    ...
    get_port()->write(uart_msg_0919_p3._msg_1.content.data, uart_msg_0919_p3._msg_1.length);
}
...
void Uart::send_0919_p4()
{
    ...
    uart_msg_0919_p4._msg_1.length = 37;
