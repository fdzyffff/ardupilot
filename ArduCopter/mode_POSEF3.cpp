...
bool ModePOSEF3::init(bool ignore_checks)
{
    ...
    _tookoff = false;
    gcs().send_text(MAV_SEVERITY_WARNING, "POSEF3");

    return true;
}

#if PRECISION_LANDING == ENABLED
bool ModePOSEF3::do_precision_loiter()
{
...
void ModePOSEF3::precision_loiter_xy()
{
    loiter_nav->clear_pilot_desired_acceleration();
...
uint32_t ModePOSEF3::wp_distance() const
{
...
void ModePOSEF3::User_alt_limit(float&  target_rate) {
