...
const AP_Param::GroupInfo UAttack::var_info[] = {
    ...
    AP_SUBGROUPPTR(_Target_ptr_cam_mav,    "TMAV_",   16, UAttack,  FD_Target_Mav),
...
void UAttack::handle_info(float p1, float p2) {
    ...
    _yaw_sample_filter.apply(_last_yaw_sample, 0.33f);
    _pitch_sample_filter.apply(angle_pitch, 0.33f);
