...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    AP_GROUPINFO("HB1_ATKRAD", 34, ParametersG2, hb1_acc_radius_preattack, 0),
    AP_GROUPINFO("HB1_FST_AUTO", 35, ParametersG2, hb1_fsauto_time, 0),
    AP_GROUPINFO("HB1_POW_TYPE", 36, ParametersG2, hb1_power_type, 0),
    AP_GROUPINFO("HB1_RPM_USED", 37, ParametersG2, hb1_rpm_used, 0),
