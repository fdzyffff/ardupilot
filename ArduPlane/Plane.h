...
// Inertial Navigation EKF
    ...
    */
    ...
    enum HB1_Power_Action_t {
        ...
        HB1_PowerAction_ParachuteON_PRE = 5,
        HB1_PowerAction_ParachuteON     = 6,
        HB1_PowerAction_GROUND_RocketON        = 7,
        HB1_PowerAction_GROUND_EngineSTART_PRE = 8,
        HB1_PowerAction_GROUND_EngineSTART     = 9,
        HB1_PowerAction_GROUND_EngineON        = 10,
        HB1_PowerAction_GROUND_EngineOFF       = 11,
        HB1_PowerAction_GROUND_EngineFULL      = 12,
        HB1_PowerAction_GROUND_EngineMID       = 13,
    };
