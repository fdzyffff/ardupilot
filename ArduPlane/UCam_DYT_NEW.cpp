...
UCam_DYT_NEW::UCam_DYT_NEW(UAttack &frotend_in, AP_HAL::UARTDriver* port_in):
...
// APM -> DYT
void UCam_DYT_NEW::fill_state_msg()
{
    ...
    FD_DYT_NEW_msg_APM2DYTTELEM &tmp_msg = FD1_uart_ptr->get_msg_APM2DYTTELEM();

    tmp_msg._msg_1.content.msg.header.head_1 = FD_DYT_NEW_msg_APM2DYTTELEM::PREAMBLE1;
    tmp_msg._msg_1.content.msg.header.head_2 = FD_DYT_NEW_msg_APM2DYTTELEM::PREAMBLE2;
...
void UCam_DYT_NEW::do_cmd() {
    ;
}

bool UCam_DYT_NEW::is_valid() {
    return _valid;
}

void UCam_DYT_NEW::handle_info(float p1, float p2) {
        // if (!_valid) {
...
// GCS -> APM -> DYT
void UCam_DYT_NEW::handle_msg(const mavlink_message_t &msg)
{
...
// DYT -> APM -> GCS
void UCam_DYT_NEW::foward_DYT_mavlink()
{
    static uint32_t _last_send_ms = 0;
