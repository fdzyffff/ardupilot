...
../../Tools/autotest/run_in_terminal_window.sh ArduPlane ../../build/sitl/bin/arduplane -S --model plane --slave 0 --serial0 tcp:5760 --serial1 tcp:5761 --serial2 tcp:5762 --serial4 tcp:5766 --instance 0 --defaults ../../extra.parm,../../Tools/autotest/models/plane.parm --home 39.9789617,116.3399792,50.0,0
