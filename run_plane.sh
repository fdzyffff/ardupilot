...
../../build/sitl/bin/arduplane --model quadplane-copter_tailsitter --serial0 tcp:5760 --serial1 tcp:5761 --serial4 tcp:5766 --instance 0 --defaults ../../Tools/autotest/default_params/quadplane.parm,../../Tools/autotest/default_params/quadplane-copter_tailsitter.parm --home 39.9789617,116.3399792,50.0,0
